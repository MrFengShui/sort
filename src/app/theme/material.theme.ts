...
const MaterialEmeraldPreset = definePreset(Material, {
    semantic: {
        primary: {
            50: '{emerald.50}',
            100: '{emerald.100}',
...
const MaterialIndigoPreset = definePreset(Material, {
    semantic: {
        primary: {
            50: '{indigo.50}',
            100: '{indigo.100}',
...
const MaterialOrangePreset = definePreset(Material, {
    semantic: {
        primary: {
            50: '{orange.50}',
            100: '{orange.100}',
...
const MaterialRosePreset = definePreset(Material, {
    semantic: {
        primary: {
            50: '{rose.50}',
            100: '{rose.100}',
...
const MaterialSkyPreset = definePreset(Material, {
    semantic: {
        primary: {
            50: '{sky.50}',
            100: '{sky.100}',
...
const MaterialVioletPreset = definePreset(Material, {
    semantic: {
        primary: {
            50: '{violet.50}',
            100: '{violet.100}',
...
export const selectMaterialPreset = (name: AppStyleColorName): void => {
    switch (name) {
        ...
        case 'indigo': usePreset(MaterialIndigoPreset); break;
        case 'orange': usePreset(MaterialOrangePreset); break;
        case 'rose': usePreset(MaterialRosePreset); break;
        case 'sky': usePreset(MaterialSkyPreset); break;
        case 'violet': usePreset(MaterialVioletPreset); break;
    }
}
