...
const NoraEmeraldPreset = definePreset(Nora, {
    semantic: {
        primary: {
            50: '{emerald.50}',
            100: '{emerald.100}',
...
const NoraIndigoPreset = definePreset(Nora, {
    semantic: {
        primary: {
            50: '{indigo.50}',
            100: '{indigo.100}',
...
const NoraOrangePreset = definePreset(Nora, {
    semantic: {
        primary: {
            50: '{orange.50}',
            100: '{orange.100}',
...
const NoraRosePreset = definePreset(Nora, {
    semantic: {
        primary: {
            50: '{rose.50}',
            100: '{rose.100}',
...
const NoraSkyPreset = definePreset(Nora, {
    semantic: {
        primary: {
            50: '{sky.50}',
            100: '{sky.100}',
...
const NoraVioletPreset = definePreset(Nora, {
    semantic: {
        primary: {
            50: '{violet.50}',
            100: '{violet.100}',
...
export const selectNoraPreset = (name: StyleColorName): void => {
    switch (name) {
        ...
        case 'indigo': usePreset(NoraIndigoPreset); break;
        case 'orange': usePreset(NoraOrangePreset); break;
        case 'rose': usePreset(NoraRosePreset); break;
        case 'sky': usePreset(NoraSkyPreset); break;
        case 'violet': usePreset(NoraVioletPreset); break;
    }
}
